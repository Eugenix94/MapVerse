    ...
    <div className="app-layout">
      ...
      <div className="app-main">
        {sandboxViewMode === '2d' ? (
          ...
          <div style={{ width: '100%', height: '100%', cursor: 'grab', background: '#000' }}>
            <Globe
              globeImageUrl="//unpkg.com/three-globe/example/img/earth-blue-marble.jpg"
              bumpImageUrl="//unpkg.com/three-globe/example/img/earth-topology.png"
              backgroundImageUrl="//unpkg.com/three-globe/example/img/night-sky.png"
            />
            <div style={{ position: 'absolute', bottom: '20px', width: '100%', textAlign: 'center', color: '#aaa', pointerEvents: 'none' }}>
              Switch back to the 2D Map to draw an extraction polygon.
            </div>
          </div>
        )}
      </div>
